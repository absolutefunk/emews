...
python /home/absolutefunk/school/research/CORE/coremews/pyCORE/src/emews/client/singleserviceclient.py -n %s -c autossh-1.yml AutoSSH
""" % (node.name)
