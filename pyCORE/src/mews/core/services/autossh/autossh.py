...
class AutoSSH(object):
    ...
    def start(self):
        ...
        if self._port is None or isinstance(self._port) is not int or \
        ...
        if self._command_count is None or isinstance(self._command_count) is not int or \
