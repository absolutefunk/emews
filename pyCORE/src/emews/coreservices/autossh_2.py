...
python /home/absolutefunk/school/research/CORE/coremews/pyCORE/src/emews/client/singleserviceclient.py -n %s -c autossh-2.yml AutoSSH
""" % (node.name)
