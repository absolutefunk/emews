...
class EmewsDaemon(UtilService):
    '''
    CORE Service class for the eMews daemon
    '''
    _name = "eMews Daemon"

    _configs = ("emewsconf.yml")
    _startindex = 1  # make sure this is higher than the emews daemon CoreService
    _dirs = ()
    _startup = ("python /home/coreuser/emews/emewsdaemon.py --c emewsconf.yml")
    _shutdown = ()
    _validate = ()
